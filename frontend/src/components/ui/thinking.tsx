...
export default function ThinkingState({
  ...
  const v = {
    active: customActive || baseVariant.active,
    done: customDone || baseVariant.done,
    rows: customRows || baseVariant.rows,
    query: baseVariant.query,
  };
  ...
  return (
    <div key={variant} className="flex min-h-[176px] w-full max-w-xl flex-col">
